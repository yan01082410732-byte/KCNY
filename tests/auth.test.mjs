...
test("language validation", () => { assert.equal(isLanguage("CN"), true); assert.equal(isLanguage("KR"), true); assert.equal(isLanguage("zh"), false); assert.equal(isLanguage("ko"), false); assert.equal(isLanguage("en"), false); });
