...
test("notification timestamps use a deterministic timezone to avoid hydration mismatches", () => { assert.match(client, /timeZone: "Asia\/Seoul"/); assert.doesNotMatch(client, /toLocaleString\(/); });
